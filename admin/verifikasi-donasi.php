...
<!-- Modal Tolak Donasi -->
<div id="modalTolak" class="fixed inset-0 z-[70] hidden flex items-center justify-center p-4">
    <div class="absolute inset-0 bg-cypress-950/50 veil-blur"></div>
    <div class="relative bg-white rounded-3xl max-w-md w-full p-6 border border-red-200 shadow-2xl space-y-4">
