...
$banners = $pdo->query("SELECT * FROM banners ORDER BY urutan ASC, id DESC")->fetchAll();
...
<div class="bg-white rounded-3xl border border-antique-300/50 shadow-sm overflow-hidden">
    <div class="p-6 border-b border-antique-200 flex items-center justify-between">
        ...
        <span class="text-xs text-warm-800/60 font-semibold"><?= count($banners) ?> Banner</span>
    </div>
...
<div id="modalBanner" class="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs hidden flex items-center justify-center p-4">
