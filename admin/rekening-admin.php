...
<div id="modalRekening" class="fixed inset-0 z-[70] hidden flex items-center justify-center p-4">
    <div class="absolute inset-0 bg-cypress-950/50 veil-blur"></div>
    <div class="relative bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 border border-antique-300 shadow-2xl space-y-4 text-xs">
