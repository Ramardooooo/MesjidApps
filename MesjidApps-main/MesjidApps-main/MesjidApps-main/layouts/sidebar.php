...
<!-- ==============================================================================
     ...
     ============================================================================== -->
<header class="lg:hidden sticky top-0 z-30 bg-cypress-900 text-white border-b border-antique-500/30 px-4 py-3 flex items-center justify-between shadow-sm no-print">
...
<div class="lg:pl-72 flex-1 flex flex-col justify-between min-h-screen">
    ...
    <!-- Header Desktop -->
    <header class="hidden lg:flex bg-white/90 backdrop-blur-md sticky top-0 z-20 border-b border-antique-300/40 px-8 py-3.5 items-center justify-between no-print shadow-xs">
        <div class="flex items-center gap-2.5">
